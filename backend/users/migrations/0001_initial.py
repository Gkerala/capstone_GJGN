    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=users.models.profile_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal_mode', models.CharField(default='maintain', max_length=20)),
                ('goal_calories', models.IntegerField(blank=True, null=True)),
                ('goal_carbs', models.IntegerField(blank=True, null=True)),
                ('goal_protein', models.IntegerField(blank=True, null=True)),
                ('goal_fat', models.IntegerField(blank=True, null=True)),
